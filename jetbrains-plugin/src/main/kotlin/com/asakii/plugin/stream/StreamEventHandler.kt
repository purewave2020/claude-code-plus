package com.asakii.plugin.stream
...
object StreamEventHandler {
    ...
    fun applyThinkingDelta(
        ...
        val thinkingText = delta["thinking"]?.jsonPrimitive?.content ?: return false
...
data class MutableAssistantMessage(
    ...
    var model: String,
    var tokenUsage: com.asakii.claude.agent.sdk.types.TokenUsage? = null
)
